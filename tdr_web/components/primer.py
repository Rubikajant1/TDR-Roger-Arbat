...
# Creo una variable amb totse els alumnes de primer d'ESO de la base de dades
...
def front_primer():
    return rx.box(
        ...
        rx.center(
            rx.vstack(
                # Titol
                rx.heading("Gestió d'estudiants de 1r d'ESO", size="7",align='center',color=colors.VERD.value),
                rx.hstack(
