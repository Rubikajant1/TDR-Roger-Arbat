### Primer ###
#Fitxer per als alumnes de primer d'ESO
...
# Creo una variable amb tots els alumnes de primer d'ESO de la base de dades
# Només surten els alumnes que s'han insertat com que fan primer d'eso
# Tots els altres alumnes no surten
db1 = dbalumnes.find({'Curs': '1r ESO'})


# Creo una classe amb totes les funcions variables... que nescesito per el bak-end.
class AlumneState1r(rx.State):
    ...
    def load_alumnes(self):
        ...
        #Només dels alumnes de 1r d'ESO
        raw_alumnes = [
            {**alumne, '_id': str(alumne['_id'])}
            for alumne in dbalumnes.find({'Curs':'1r ESO'})
        ]
...
# Funciò front-end per als alumnes de primer d'ESO
def front_primer():
    return rx.box(
        #Cridar la navbar
        navbar(),
        rx.center(
            rx.vstack(
                ...
                rx.heading(
                    #Text
                    "Gestió d'estudiants de 1r d'ESO",
                    #Mida
                    size="7",
                    #Aliniar títol
                    align='center',
                ...
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState1r.increment_selected_retards,
                        #Color de fons
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState1r.increment_selected_faltesnj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState1r.increment_selected_faltesj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                ...
                ag_grid(
                    ...
                    #Agafar els alumnes de primer d'eso com a dades
                    row_data=AlumneState1r.alumnes,
                    #Amplada de la taula
                    width="1200px",
                    #Altura de la taula
                    height="45vh",
                    ...
                    on_selection_changed=AlumneState1r.handle_selection_changed,
                    z_index = '0%'
                ),
                ...
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState1r.restar_selected_retards,
                        #Color de fons
                        background_color=colors.PRIMARY.value,
                        #Amplada
                        width = '240px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState1r.restar_selected_faltesnj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState1r.restar_selected_faltesj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada a 243px
                        width = '243px'
