...
# Creo una variable amb totse els alumnes de quart d'ESO de la base de dades
...
def front_quart():
    return rx.box(
        ...
        rx.center(
            rx.vstack(
                # Titol
                rx.heading("Gestió d'estudiants de 4t d'ESO", size="7",align='center',color=colors.VERD.value),
                rx.hstack(
