### Quart ###
#Fitxer per als alumnes de quart d'ESO
...
# Creo una variable amb tots els alumnes de quart d'ESO de la base de dades
# Només surten els alumnes que s'han insertat com que fan quart d'eso
# Tots els altres alumnes no surten
db1 = dbalumnes.find({'Curs': '4t ESO'})


# Creo una classe amb totes les funcions variables... que nescesito per el bak-end.
class AlumneState4t(rx.State):
    ...
    def load_alumnes(self):
        ...
        #Només dels alumnes de 4t d'ESO
        raw_alumnes = [
            {**alumne, '_id': str(alumne['_id'])}
            for alumne in dbalumnes.find({'Curs':'4t ESO'})
        ]
...
# Funciò front-end per als alumnes de quart d'ESO
def front_quart():
    return rx.box(
        #Cridar la navbar
        navbar(),
        rx.center(
            rx.vstack(
                ...
                rx.heading(
                    #Text
                    "Gestió d'estudiants de 4t d'ESO",
                    #Mida
                    size="7",
                    #Aliniar títol
                    align='center',
                ...
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState4t.increment_selected_retards,
                        #Color de fons
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState4t.increment_selected_faltesnj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState4t.increment_selected_faltesj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                ...
                ag_grid(
                    ...
                    #Agafar els alumnes de quart d'eso com a dades
                    row_data=AlumneState4t.alumnes,
                    #Amplada de la taula
                    width="1200px",
                    #Altura de la taula
                    height="45vh",
                    ...
                    on_selection_changed=AlumneState4t.handle_selection_changed,
                    z_index = '0%'
                ),
                ...
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState4t.restar_selected_retards,
                        #Color de fons
                        background_color=colors.PRIMARY.value,
                        #Amplada
                        width = '240px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState4t.restar_selected_faltesnj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState4t.restar_selected_faltesj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada a 243px
                        width = '243px'
