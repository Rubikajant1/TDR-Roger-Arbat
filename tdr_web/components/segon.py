### Primer ###
#Fitxer per als alumnes de segon d'ESO
...
class AlumneState2n(rx.State):
    ...
    def load_alumnes(self):
        ...
        raw_alumnes = [
            ...
            for alumne in dbalumnes.find({'Curs':'2n ESO'})
        ]
...
# Funciò front-end per als alumnes de segon d'ESO
def front_segon():
    return rx.box(
        #Cridar la navbar
        navbar(),
        rx.center(
            rx.vstack(
                ...
                rx.heading(
                    #Text
                    "Gestió d'estudiants de 2n d'ESO",
                    #Mida
                    size="7",
                    #Aliniar títol
                    align='center',
                ...
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState2n.increment_selected_retards,
                        #Color de fons
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState2n.increment_selected_faltesnj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState2n.increment_selected_faltesj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                ...
                ag_grid(
                    ...
                    #Agafar els alumnes de segon d'eso com a dades
                    row_data=AlumneState2n.alumnes,
                    #Amplada de la taula
                    width="1200px",
                    #Altura de la taula
                    height="45vh",
                    ...
                    on_selection_changed=AlumneState2n.handle_selection_changed,
                    z_index = '0%'
                ),
                ...
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState2n.restar_selected_retards,
                        #Color de fons
                        background_color=colors.PRIMARY.value,
                        #Amplada
                        width = '240px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState2n.restar_selected_faltesnj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada
                        width = '243px'
                    ...
                    rx.button(
                        ...
                        on_click=AlumneState2n.restar_selected_faltesj,
                        #Color de fons
                        background_color = colors.PRIMARY.value,
                        #Amplada a 243px
                        width = '243px'
